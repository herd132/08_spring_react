...
// readCountData, likeCountData, commentCountData 에 변화가 감지될 때 콜백함수 내용
    ...
    return (
      <div>
        ...
        <section className="statistics-section">
          ...
          <p>게시글 번호/제목 : {likeCountData.boardNo} / {likeCountData.boardTitle}</p> 
          {/* <img src={'http://localhost:8080' + likeCountData.imgPath} /> */}
